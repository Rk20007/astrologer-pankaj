...
export default function ContentIndexPage() {
  // Group sections for a tidy listing.
  const groups = {};
  ...
  return (
    <div>
      <h1 className="mb-1 text-2xl font-bold text-gray-900">Website Content</h1>
      ...
      <div className="space-y-8">
        {Object.entries(groups).map(([group, items]) => (
          <div key={group}>
            <h2 className="mb-3 text-xs font-bold uppercase tracking-wider text-gray-400">{group}</h2>
