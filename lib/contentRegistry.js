...
import { site, contactInfo, contactsDefault } from '@/data/site';
...
import { paymentConfig } from '@/data/payment';
...
export const contentRegistry = {
  ...
  homeBanner: {
    label: 'Home — Banner',
    description:
      'The big banner at the top of the home page: badge, headline, description, buttons, the photo and the three figures under it.',
    group: 'Home Page',
    default: homeBanner,
  },
  stats: {
  ...
  reels: {
    ...
    description:
      'Reels shown on the home and podcast pages. "Id" is the reel shortcode — the bit between /reel/ and the next slash in its URL, e.g. DbKbYK0IF4M.',
    group: 'Content',
    default: reels,
  },
  ...
  whatsappContacts: {
    ...
    description:
      'The call / WhatsApp lines shown in the footer, on the contact page and on the floating button. The first one is the primary line.',
    group: 'Site-wide',
  ...
  payment: {
    label: 'Payment (UPI QR & Bank)',
    description:
      'The QR image, UPI ID, bank account and instructions shown on the payment step. Upload a new QR under Images, then pick it in the "Qr Image" field.',
    group: 'Site-wide',
